...
- Current demonstrations: `python3 -m accounting_harness demo-accounts`, `python3 -m accounting_harness demo-journal`, and `python3 -m accounting_harness demo-ledger`.
- Application tests exist for Steps 02–04. Update the documented commands and CI with each new behavior. A foundation check passing does not prove application behavior works.
